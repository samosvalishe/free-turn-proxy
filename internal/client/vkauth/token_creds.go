...
// fetchTurnCreds performs step 4 of the token chain: it calls
// vchat.joinConversationByLink and extracts the TURN username, credential, and
// address list from the response.
