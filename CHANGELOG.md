...
* удалён флаг -auth и URI-параметр auth; Client ID теперь всегда в первой записи туннеля — старые клиенты/серверы несовместимы.
...
* Client ID шлётся всегда, симметричный wire авторизации ([c56836c](https://github.com/samosvalishe/free-turn-proxy/commit/c56836cd252bef66e23450c85c6105aae2181c90))
